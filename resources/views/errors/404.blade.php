    ...
    <div class="wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top border-bottom">
            <a class="navbar-brand" href="javascript:;">
                <img src="{{ asset('/') }}backend/assets/images/logo-img.png" width="160" alt="">
            </a>
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <p>You have reached the edge of the universe.
                                    ...
                                    <br>Dontworry and return to the previous page.</p>
                                <div class="mt-5"> <a href="{{ route('admin.home.index') }}" class="btn btn-lg btn-primary px-md-5 radius-30">Go Home</a>
                                    <a href="javascript:;" class="btn btn-lg btn-outline-dark ml-3 px-md-5 radius-30">Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <img src="{{ asset('/') }}backend/assets/images/errors-images/404-error.png" class="card-img" alt="">
                        </div>
                    </div>
                    <!--end row-->
                </div>
        ...
        <div class="bg-white p-4 fixed-bottom border-top">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <p class="mb-0">Zuyel @2020 | Developed By : <a href="https//iamzuyel.xyz" target="_blank">Zuyel</a>
                </p>
            </div>
        </div>
    </div>
