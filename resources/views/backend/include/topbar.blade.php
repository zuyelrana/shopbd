                        ...
                        <div class="header-notifications-list">
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <h6 class="msg-name">New Product Approved <span class="msg-time float-right">2
                                                hrs ago</span></h6>
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <h6 class="msg-name">Your item is shipped <span class="msg-time float-right">5
                                                hrs
                                                ago</span></h6>
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <h6 class="msg-name">Defense Alerts <span class="msg-time float-right">2
                                                weeks
                                                ago</span></h6>
